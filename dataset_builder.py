...
from .FoodSeg103 import foodseg103
from .single_foodseg103 import single_foodseg103
from .unimib import unimib
from .mafood import mafood # Daniel
...
MODEL_TABLE = {
    ...
    'single_foodseg103': single_foodseg103,
    'unimib': unimib,
    'mafood': mafood, # Daniel
}
